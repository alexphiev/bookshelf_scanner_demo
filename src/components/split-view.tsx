...
export const SplitView = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <Card className="hidden h-full w-full flex-col justify-center overflow-hidden rounded-lg shadow-2xl lg:flex lg:h-[800px] lg:w-[1000px]">
        <div className="container relative grid h-[800px] flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
          ...
          <div className="hidden h-full w-full flex-col justify-between p-4 lg:flex lg:p-8">
            {children}
          </div>
        </div>
      </Card>
